...
//
// based on Demo Example from Good Display: https://www.good-display.com/comp/xcompanyFile/downloadNew.do?appId=24&fid=1785&id=1151
// Panel: GDEY029F51H : https://www.good-display.com/product/464.html
// Controller: JD79667, no specs, see GDEY0266F51H panel specs for command list subset
//
...
#include "GxEPD2_154c_GDEY0154F51H.h"

GxEPD2_154c_GDEY0154F51H::GxEPD2_154c_GDEY0154F51H(int16_t cs, int16_t dc, int16_t rst, int16_t busy) :
  GxEPD2_EPD(cs, dc, rst, busy, LOW, 50000000, WIDTH, HEIGHT, panel, hasColor, hasPartialUpdate, hasFastPartialUpdate)
{
  _paged = false;
}

void GxEPD2_154c_GDEY0154F51H::clearScreen(uint8_t value)
{
  clearScreen(value, 0xFF);
}

void GxEPD2_154c_GDEY0154F51H::clearScreen(uint8_t black_value, uint8_t color_value)
{
  writeScreenBuffer(black_value, color_value);
  refresh();
}

void GxEPD2_154c_GDEY0154F51H::writeScreenBuffer(uint8_t value)
{
  writeScreenBuffer(value, 0xFF);
}

void GxEPD2_154c_GDEY0154F51H::writeScreenBuffer(uint8_t black_value, uint8_t color_value)
{
...
void GxEPD2_154c_GDEY0154F51H::writeImage(const uint8_t bitmap[], int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
...
void GxEPD2_154c_GDEY0154F51H::writeImage(const uint8_t* black, const uint8_t* color, int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
...
void GxEPD2_154c_GDEY0154F51H::writeImagePart(const uint8_t bitmap[], int16_t x_part, int16_t y_part, int16_t w_bitmap, int16_t h_bitmap,
...
void GxEPD2_154c_GDEY0154F51H::writeImagePart(const uint8_t* black, const uint8_t* color, int16_t x_part, int16_t y_part, int16_t w_bitmap, int16_t h_bitmap,
    int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
  //Serial.print("writeImagePart("); Serial.print(x_part); Serial.print(", "); Serial.print(y_part); Serial.print(", ");
  //Serial.print(w_bitmap); Serial.print(", "); Serial.print(h_bitmap); Serial.print(", ");
...
void GxEPD2_154c_GDEY0154F51H::writeNative(const uint8_t* data1, const uint8_t* data2, int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
  if (!data1) return;
...
void GxEPD2_154c_GDEY0154F51H::writeNativePart(const uint8_t* data1, const uint8_t* data2, int16_t x_part, int16_t y_part, int16_t w_bitmap, int16_t h_bitmap,
    int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
  if (!data1) return;
  delay(1); // yield() to avoid WDT on ESP8266 and ESP32
...
void GxEPD2_154c_GDEY0154F51H::drawImage(const uint8_t bitmap[], int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
  writeImage(bitmap, x, y, w, h, invert, mirror_y, pgm);
  refresh(x, y, w, h);
}

void GxEPD2_154c_GDEY0154F51H::drawImagePart(const uint8_t bitmap[], int16_t x_part, int16_t y_part, int16_t w_bitmap, int16_t h_bitmap,
    int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
...
void GxEPD2_154c_GDEY0154F51H::drawImage(const uint8_t* black, const uint8_t* color, int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
  writeImage(black, color, x, y, w, h, invert, mirror_y, pgm);
  refresh(x, y, w, h);
}

void GxEPD2_154c_GDEY0154F51H::drawImagePart(const uint8_t* black, const uint8_t* color, int16_t x_part, int16_t y_part, int16_t w_bitmap, int16_t h_bitmap,
    int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
...
void GxEPD2_154c_GDEY0154F51H::drawNative(const uint8_t* data1, const uint8_t* data2, int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
  writeNative(data1, data2, x, y, w, h, invert, mirror_y, pgm);
  refresh(x, y, w, h);
}

void GxEPD2_154c_GDEY0154F51H::refresh(bool partial_update_mode)
{
  if (hasPartialUpdate) _setPartialRamArea(0, 0, WIDTH, HEIGHT);
  _refresh(partial_update_mode);
}

void GxEPD2_154c_GDEY0154F51H::refresh(int16_t x, int16_t y, int16_t w, int16_t h)
{
...
void GxEPD2_154c_GDEY0154F51H::powerOff()
{
  _PowerOff();
}

void GxEPD2_154c_GDEY0154F51H::hibernate()
{
  _PowerOff();
  if (_rst >= 0)
  {
...
void GxEPD2_154c_GDEY0154F51H::setPaged()
{
  if (!hasPartialUpdate)
  {
    _paged = true;
...
void GxEPD2_154c_GDEY0154F51H::_refresh(bool partial_update_mode)
{
...
void GxEPD2_154c_GDEY0154F51H::_setPartialRamArea(uint16_t x, uint16_t y, uint16_t w, uint16_t h, bool partial_mode)
{
...
void GxEPD2_154c_GDEY0154F51H::_PowerOn()
{
  if (!_power_is_on)
  {
    _writeCommand(0x04);
...
void GxEPD2_154c_GDEY0154F51H::_PowerOff()
{
  if (_power_is_on)
  {
    _writeCommand(0x02);
...
void GxEPD2_154c_GDEY0154F51H::_InitDisplay()
{
  ...
  _writeData(0x0F);    // default res (176x296)), scan up, shift left, booster on, no effect (no RST)
  _writeData(0x29);    // LUT from MPT, no add scan, VCOM default, TS_AUTO, VGN default, VCOM default, VCOM floating after refresh
  ...
  _writeData(0x05);    // PHB_SFT, PHA_SFT
  _writeData(0x00);    // PHA_ON
  _writeData(0x3F);    // PHA_OFF
  _writeData(0x0A);    // PHB_ON
  _writeData(0x25);    // PHB_OFF
  _writeData(0x12);    // PHC_ON
  _writeData(0x1A);    // PHC_OFF
  ...
  _writeData(0x08);    // Dynamic frame rate enabled
  _PowerOn();
